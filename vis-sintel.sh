...
env SAVECORR=nof2corr-sintel-$SET.pth python3 evaluate.py --model results/sintel/craft-nof2/craft-sintel.pth --craft --setrans --f2 none --img1 datasets/Sintel/test/$SET/market_4/frame_0034.png --img2 datasets/Sintel/test/$SET/market_4/frame_0035.png
...
python3 attvis.py --model nof2 --img1 datasets/Sintel/test/$SET/market_4/frame_0034.png --img2 datasets/Sintel/test/$SET/market_4/frame_0035.png --points 16,160.32,280 --att nof2corr-sintel-$SET.pth --savedir attvis/$SET
