...
class TransCorrBlock(CorrBlock, nn.Module):
    ...
    def update(self, fmap1, fmap2, coords1, coords2=None, 
               f1_pos_embed_weight=None, f2_pos_embed_weight=None):
        self.corr_pyramid = []
        ...
        vispos1 = self.vispos_encoder(fmap1, coords1, f1_pos_embed_weight)
        vispos2 = self.vispos_encoder(fmap2, coords2, f2_pos_embed_weight)
        batch, dim, ht, wd = fmap1.shape
        # all pairs correlation
