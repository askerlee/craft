...
python3 evaluate.py --model checkpoints/gma-sintel.pth --dataset slowflow --xshifts 100,120,140,160,180,200,220,240,260,280,300 --yshifts 50,60,70,80,90,100,110,120,130,140,150 --slowset 100,9
...
python3 evaluate.py --model checkpoints/gma-sintel.pth --dataset sintel --xshifts 100,120,140,160,180,200,220,240,260,280,300 --yshifts 50,60,70,80,90,100,110,120,130,140,150
